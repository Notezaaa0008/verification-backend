          ...
          dataForAver = [
            ...dataForAver,
            {
              date: `${item.endVerification.getFullYear()}${
                item.endVerification.getMonth() < 10
                  ? "0" + (item.endVerification.getMonth() + 1)
                  : item.endVerification.getMonth() + 1
              }${
                item.endVerification.getDate() < 10
                  ? "0" + item.endVerification.getDate()
              ...
              task: [
                {
                  ...
                  startDate: `${startDate.getFullYear()}${
                    startDate.getMonth() < 10 ? "0" + (startDate.getMonth() + 1) : startDate.getMonth() + 1
